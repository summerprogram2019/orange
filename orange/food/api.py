...
lookup = {
    ...
    'calories': ('total calories', ureg.calorie),
    'fat': ('total fat', ureg.gram),
    'sat_fat': ('saturated fat', ureg.gram),
    'sodium': ('sodium', ureg.milligram),
    'carbs': ('total carbohydrates', ureg.gram),
    'fibre': ('dietary fiber', ureg.gram),
    'protein': ('protein', ureg.gram),
    'vitamin_a': ('vitamin A', ureg.microgram),
    'vitamin_b12': ('vitamin B12', ureg.microgram),
    'vitamin_b6': ('vitamin B6', ureg.microgram),
    'vitamin_c': ('vitamin C', ureg.milligram),
    'vitamin_d': ('vitamin D', ureg.nanogram),
    'vitamin_e': ('vitamin E', ureg.milligram),
    ...
    'vitamin_b5': ('panto acid', ureg.microgram),
